  ...
  return (
    <div className="p-6">
      <form action={functionAction} className="space-y-4">
        ...
        <button
          type="submit"
          className="bg-blue-500 w-full bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
        >
